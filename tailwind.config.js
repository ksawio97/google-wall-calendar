  ...
  theme: {
    extend: {
        ...
        colors: {
            ...
            // Extended Colors
            'custom-color1': 'var(--md-extended-color-custom-color1-color)',
            'on-custom-color1': 'var(--md-extended-color-custom-color1-on-color)',
            'custom-color1-container': 'var(--md-extended-color-custom-color1-color-container)',
            'on-custom-color1-container': 'var(--md-extended-color-custom-color1-on-color-container)',
            'custom-color2': 'var(--md-extended-color-custom-color2-color)',
            'on-custom-color2': 'var(--md-extended-color-custom-color2-on-color)',
            'custom-color2-container': 'var(--md-extended-color-custom-color2-color-container)',
            'on-custom-color2-container': 'var(--md-extended-color-custom-color2-on-color-container)',
        },
